...
export const CATEGORY_DEFINITIONS: Record<string, CategoryDefinition> = {
  "AI & Machine Learning": {
    ...
    keywords: ["machine-learning", "deep-learning", "neural", "openai", "anthropic", "langchain", "diffusion", "stable-diffusion", "image-generation", "text-generation", "llm", "chatgpt", "ollama", "deepseek", "artificial intelligence"],
  ...
  "APIs & Backend": {
    topics: ["api", "backend", "server", "rest", "graphql", "rest-api", "http-server", "bot", "discord-bot", "micro-framework", "php-framework", "mvc"],
    keywords: ["backend", "graphql", "endpoint", "express", "fastapi", "nestjs", "hono", "trpc", "http-framework", "http-client"],
    priority: 6,
  },
  "Background Jobs": {
    topics: ["background-jobs", "job-queue", "task-queue", "worker", "message-queue", "async-jobs"],
    keywords: ["sidekiq", "resque", "delayed_job", "background-job", "job-queue", "task-queue", "worker", "queue", "backgrounded"],
    namePatterns: ["shoryuken"],
    priority: 7,
  },
  "Blockchain & Web3": {
    topics: ["blockchain", "ethereum", "solidity", "web3", "cryptocurrency", "crypto", "defi", "smart-contracts", "nft"],
    keywords: ["blockchain", "ethereum", "solidity", "web3", "crypto", "smart-contract", "evm", "defi", "token", "wallet"],
    priority: 8,
  },
  "Data & Visualization": {
    topics: ["data-visualization", "charts", "charting", "visualization", "plotting"],
    keywords: ["chart", "d3js", "plotly", "recharts", "visualization", "unovis"],
    priority: 6,
  },
  Database: {
    topics: ["database", "sql", "nosql", "orm", "postgresql", "mysql", "mongodb", "redis", "sqlite"],
    keywords: ["database", "sql", "postgres", "mysql", "mongodb", "redis", "sqlite", "orm", "activerecord", "mongoid"],
    priority: 7,
  },
  "Design Resources": {
    topics: ["icons", "svg", "fonts", "assets", "design-resources", "logos", "illustrations", "font", "typeface", "coding-font"],
    keywords: ["icons", "svg-icons", "fonts", "logo", "logos", "illustrations", "icon-pack", "monospaced font", "programming font"],
    namePatterns: ["-icons", "-assets"],
    priority: 7,
  },
  "Developer Tools": {
    topics: ["developer-tools", "devtools", "cli", "tooling", "productivity-tools", "developer-tool", "vim-plugin", "neovim-plugin", "editor", "ide", "code-editor", "syntax-highlighting"],
    keywords: ["cli", "debug", "lint", "format", "editor", "terminal", "eslint", "prettier", "vim", "neovim", "dotfiles", "irb", "repl", "console", "environment variable"],
    namePatterns: ["-cli", "vim-", "-vim", "dotenv"],
    priority: 6,
  },
  Documentation: {
    topics: ["documentation", "docs", "wiki", "awesome-list", "learning", "style-guide", "documentation-tool", "documentation-generator", "challenges"],
    keywords: ["documentation", "styleguide", "style-guide", "tutorial", "awesome", "cheatsheet", "handbook", "guidelines", "intro to", "starter template", "boilerplate"],
    namePatterns: ["awesome-", "-guide", "-styleguide", "-docs", "-starter"],
    priority: 7,
  },
  ...
  Productivity: {
    topics: ["productivity", "automation", "workflow", "note-taking", "task-management", "obsidian-plugin"],
    keywords: ["automate", "workflow", "productivity", "todo", "note-taking", "whiteboard", "collaboration"],
    priority: 5,
  },
  "Runtime & Build Tools": {
    topics: ["runtime", "bundler", "compiler", "transpiler", "build-tool", "package-manager", "typechecker", "language"],
  ...
  "State Management": {
    topics: ["state-management", "redux", "state"],
    keywords: ["zustand", "jotai", "immer", "mobx", "recoil", "state management", "flux"],
    priority: 7,
  },
  "Testing & Quality": {
    topics: ["testing", "test", "unit-testing", "integration-testing", "code-quality", "profiling", "benchmark"],
    keywords: ["testing", "profiler", "benchmark", "load-testing", "coverage", "code quality", "n+1", "quality threshold"],
    namePatterns: ["-test", "-spec", "-benchmark"],
    priority: 7,
  },
  "UI Components": {
    topics: ["ui", "components", "design-system", "component-library", "ui-components", "ui-library", "css-framework", "frontend", "ui-kit", "web-components"],
    keywords: ["shadcn", "radix", "headless-ui", "ui-kit", "user interface", "css framework"],
    namePatterns: ["-ui", "-components", "ui-"],
    priority: 8,
  },
  Utilities: {
    topics: ["utility", "utilities", "toolkit", "tools", "desktop"],
    keywords: ["pdf", "converter", "generator", "calculator", "invoice", "screenshot", "snippet", "downloader", "powertoys"],
